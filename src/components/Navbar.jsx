...
const Navbar = () => {
  ...
  const admin = () => {
    toast({
      title: "Приветствуем Админ.",
      description: `Ваши учётные данные предоставлены здесь
        Почтовый адрес: admin@admin.com  пароль: 123456.`,
      status: "success",
      duration: 6000,
        ...
        >
              ...
              <Box width={{ base: "0", md: "80%" }}>
                ...
                >
                  <Box
                    ...
                    // bgColor="#f0f1f7 "
                  >
                    <Box as="button" onClick={() => GoTo("/company")}>
                      1С:Предприятие
                    </Box>
                    <Box as="button" onClick={() => GoTo("/processing")}>
                      Обработки 1С
                    </Box>
                    <Box as="button" onClick={() => GoTo("/services")}>
                      Сервисы 1С
                    </Box>
                  </Box>
                </Flex>
          ...
          >
            ...
            >
              ...
              {user && user.isLogin ? `Приветствуем ${user.firstName}` : "Войти"}
            </Button>
            <Drawer
              isOpen={isOpen}
              placement="right"
