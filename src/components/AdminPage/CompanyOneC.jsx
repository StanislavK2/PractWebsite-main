...
import Pdoduct from './ProcessingOneC';
  ...
  dispatch(UPDATE_Cloth_item(id,Creds))
    ...
    return (
        ...
        <select onChange={(e)=>HandleFilterChang(e.target.value)} style={{border:"1px solid black"}} >
            <option value="Mens">Программы для ЖКХ</option>
            <option value="Womens">Наши разработки</option>
            <option value="KIDS">Отраслевые решения</option>
        </select>
                               ...
                               <ModalContent>
                                  ...
                                  <ModalBody pb={6}>
                                    ...
                                    <form  onSubmit={handleSubmit}>
                                        ...
                                        <Stack>
                                        <input type="text" name='price'  style={{border:"1px solid black"}}  onChange={hanldeChange} placeholder="Цена" />
                                        </Stack>
                                        <Stack>
